							...
							if (companyCount == 5):
								...
								for s in states:
									...
									for c in counties:
										...
										cursor.execute(sqlComm)
										conn.commit()
										print "process " + company + " for state " + s[0] + " county " + c[0] + " takes " + int((time.time()-starttimeCounty)/60)
									print "process " + company + " for state " + s[0] + " takes " + int((time.time()-starttimeState)/60)				
		print "Whole Process taken in " + int((time.time()-starttime)/60)
